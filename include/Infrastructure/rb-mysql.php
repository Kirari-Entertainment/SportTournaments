 ...
 */
if (interface_exists('\JsonSerializable')) { interface Jsonable extends JsonSerializable {}
} else { interface Jsonable {}
}
...
//make some classes available for backward compatibility
    use RedBeanPHP\BeanHelper\DynamicBeanHelper;
...
if ( !function_exists( 'DBPrefix' ) ) {
	...
	function DBPrefix( $prefix = '\\Model' ) {
		return new DynamicBeanHelper( $prefix );
	}
}
